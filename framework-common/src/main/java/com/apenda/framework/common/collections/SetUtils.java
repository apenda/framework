package com.apenda.framework.common.collections;
...
public class SetUtils {
     ...
     * @since 4.1
     */
    public static <E> org.apache.commons.collections4.SetUtils.SetView<E> difference(final Set<? extends E> a, final Set<? extends E> b) {
        if (a == null || b == null) {
     ...
     * @since 4.1
     */
    public static <E> org.apache.commons.collections4.SetUtils.SetView<E> disjunction(final Set<? extends E> a, final Set<? extends E> b) {
        if (a == null || b == null) {
            throw new NullPointerException("Sets must not be null.");
        }

        final org.apache.commons.collections4.SetUtils.SetView<E> aMinusB = difference(a, b);
        final org.apache.commons.collections4.SetUtils.SetView<E> bMinusA = difference(b, a);
     ...
     * @since 4.1
     */
    public static <E> org.apache.commons.collections4.SetUtils.SetView<E> intersection(final Set<? extends E> a, final Set<? extends E> b) {
        if (a == null || b == null) {
            throw new NullPointerException("Sets must not be null.");
        }
     ...
     * @since 4.1
     */
    public static <E> org.apache.commons.collections4.SetUtils.SetView<E> union(final Set<? extends E> a, final Set<? extends E> b) {
        if (a == null || b == null) {
            throw new NullPointerException("Sets must not be null.");
        }
    ...
    /**
     * Returns an new HashSet if the argument is <code>null</code>,
     * or the argument itself otherwise.
     *
     * @param set
     * @param <T>
     * @return
     */
    public static <T> Set<T> newIfNull(Set<T> set) {
        return set == null ? new HashSet<>() : set;
    }

    /**
     * Returns an new set if the argument is <code>null</code>,
     * or the argument itself otherwise.
     *
     * @param set
     * @param <T>
     * @return
     */
    public static <T> Set<T> newIfNull(Set<T> set, Class<? extends Set> clazz) throws IllegalAccessException, InstantiationException {
        return set == null ? clazz.newInstance() : set;
    }
}
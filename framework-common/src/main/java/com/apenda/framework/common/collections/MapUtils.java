...
public class MapUtils{
   ...
   //-----------------------------自定义------------------------------
    ...
    /**
     * Returns an new HashMap if the argument is <code>null</code>,
     * or the argument itself otherwise.
     *
     * @param map
     * @param <K>
     ...
     * @return
     */
    public static <K, V> Map<K, V> newIfNull(Map<K, V> map) {
        return map == null ? new HashMap<>() : map;
    }

    /**
     * Returns an new map if the argument is <code>null</code>,
     * or the argument itself otherwise.
     *
     * @param map
     * @param <K>
     ...
     * @return
     */
    public static <K, V> Map<K, V> newIfNull(Map<K, V> map, Class<? extends Map> clazz) throws IllegalAccessException, InstantiationException {
        return map == null ? clazz.newInstance() : map;
    }

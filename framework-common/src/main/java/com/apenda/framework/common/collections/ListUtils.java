...
public class ListUtils{
    ...
    public static <E> List<E> longestCommonSubsequence(final List<E> a, final List<E> b,
        ...
        final ListUtils.LcsVisitor<E> visitor = new ListUtils.LcsVisitor<>();
    ...
    public static String longestCommonSubsequence(final CharSequence a, final CharSequence b) {
        ...
        final List<Character> lcs = longestCommonSubsequence(new ListUtils.CharSequenceAsList( a ), new ListUtils.CharSequenceAsList( b ));
    ...
    /**
     * Returns an new ArrayList if the argument is <code>null</code>,
     * or the argument itself otherwise.
     *
     * @param list
     * @param <T>
    ...
    /**
     * Returns an new list if the argument is <code>null</code>,
     * or the argument itself otherwise.
     *
     * @param list
     * @param <T>
     * @return
     */
    public static <T> List<T> newIfNull(List<T> list, Class<? extends List> clazz) throws IllegalAccessException, InstantiationException {
        return list == null ? clazz.newInstance() : list;
    }
}
